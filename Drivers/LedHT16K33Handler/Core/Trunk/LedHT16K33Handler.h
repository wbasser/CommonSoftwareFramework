...
extern  void  LedHT16K33Handler_Initialize( void );
extern  void  LedHT16K33Handler_Clear( void );
extern  void  LedHT16K33Handler_SetBlink( LEDHT16K33BLINKRATE eBlinkRate );
extern  void  LedHT16K33Handler_SetBrightness( LEDHT16K33BRIGHTNESS eBrightness );
extern  void  LedHT16K33Handler_DisplayColon( BOOL bDisplayColon );
extern  void  LedHT16K33Handler_DisplayChar( U8 nDigit, U8 nCharacter, BOOL bDecimal );
extern  void  LedHT16K33Handler_DisplayNumber( U8 nBase, U32 uValue, U8 nDecimalPointLoc, BOOL bDisplayColon );
extern  void  LedHT16K33Handler_UpdateDisplay( void );
