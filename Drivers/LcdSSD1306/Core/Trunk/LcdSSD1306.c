...
void LcdSSD1306_SetDim( BOOL bState )
{
  ...
  LcdSSD1306_LocalWriteCommand( SSD1306_DEVICE_ADDRESS, SSD1306_SETCONTRAST );
  LcdSSD1306_LocalWriteCommand( SSD1306_DEVICE_ADDRESS, nContrastValue );
}
...
void LcdSSD1306_WriteBuffer( void )
{
  ...
  LcdSSD1306_LocalWriteCommand( SSD1306_DEVICE_ADDRESS, SSD1306_COLUMNADDR );
  LcdSSD1306_LocalWriteCommand( SSD1306_DEVICE_ADDRESS, 0 );
  LcdSSD1306_LocalWriteCommand( SSD1306_DEVICE_ADDRESS, LCDSSD1306_DISPLAY_WIDTH - 1 );
  LcdSSD1306_LocalWriteCommand( SSD1306_DEVICE_ADDRESS, SSD1306_PAGEADDR );
  LcdSSD1306_LocalWriteCommand( SSD1306_DEVICE_ADDRESS, 0 );
  LcdSSD1306_LocalWriteCommand( SSD1306_DEVICE_ADDRESS, DISPLAY_END_PAGE );

  // output the buffer
  LcdSSD1306_LocalWriteBuffer( SSD1306_DEVICE_ADDRESS, anBuffer, BUFFER_SIZE );
}
...
void LcdSSD1306_SetScroll( LCDSSD1306DISPLAYSCROLL eScrollType, U8 nStart, U8 nStop )
{
  ...
  {
    // write the buffer
    LcdSSD1306_LocalWriteCommand( SSD1306_DEVICE_ADDRESS, anTempBuffer[ nIdx ] );
  }
}
